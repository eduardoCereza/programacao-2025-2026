...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = -85.2153;
        FollowerConstants.yMovement = -95.9388;

        FollowerConstants.forwardZeroPowerAcceleration = -89.32;
        FollowerConstants.lateralZeroPowerAcceleration = -1315.5973;
